...
SCRAPERS: dict[str, ScraperDef] = {
    ...
    "kompass": ScraperDef(
        ...
        name="Kompass",
        domain="kompass.com",
        script_file="kompass_enhanced.py",
        ...
        archive_csvs=(
            "kompass_suppliers_enriched_enhanced.csv",
    ...
    "ensun": ScraperDef(
        ...
        name="Ensun",
        domain="ensun.io",
        script_file="ensun_script.py",
        output_csv="ensun_suppliers_phase1_raw.csv",
        partial_csv="ensun_suppliers_partial_enrichment.csv",
        cleaned_csv="ensun_suppliers_cleaned.csv",
        default_sep=",",
        keywords=["cosmetic packaging", "cosmetic bottles", "cosmetic tubes"],
        countries=["China", "South Korea", "Taiwan", "Japan", "Vietnam", "Thailand"],
        archive_csvs=("ensun_suppliers_partial_scrape.csv",),
    ),
    "europages": ScraperDef(
        id="europages",
        name="Europages",
        domain="europages.co.uk",
        script_file="eurpages_scraper.py",
        output_csv="europages_suppliers_phase1_raw.csv",
        partial_csv="europages_suppliers_enrich_progress.csv",
        cleaned_csv="europages_suppliers_cleaned.csv",
        default_sep=",",
        keywords=["cosmetic packaging", "cosmetic bottles", "cosmetic tubes"],
        countries=["China", "South Korea", "Taiwan", "Japan", "Vietnam", "Thailand"],
        archive_csvs=("europages_suppliers_scrape_progress.csv",),
    ),
}
